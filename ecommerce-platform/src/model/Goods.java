...
public class Goods {
    ...
    public String toString() {
        return "Goods [id=" + id + ", name=" + name + ", cover=" + cover + ", image1=" + image1 + ", " +
                "image2=" + image2 + ", price=" + price + ", intro=" + intro + ", " +
                "stock=" + stock + ", type=" + type + "]";
    }

    public boolean getIsScroll() { return isScroll; }
    public void setScroll(boolean isScroll) { this.isScroll = isScroll; }
